                ...
                <form action="{{ route('mahasiswas.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        @foreach ($faculties as $faculty)
                            <option value="{{ $faculty }}" {{ old('fakultas')==$faculty ? 'selected': '' }}>{{ $faculty }}</option>
                        @endforeach
                        </select>
                        @error('fakultas')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="jurusan" name="jurusan" value="{{ old('jurusan') }}" class="form-control @error('jurusan') is-invalid @enderror">
                        @error('jurusan')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" id="ipk" name="ipk" value="{{ old('ipk') }}" step="any" class="form-control @error('ipk') is-invalid @enderror">
